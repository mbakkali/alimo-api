package com.sunitkatkar.blogspot.config;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.sunitkatkar.blogspot"))
    ...
    private ApiInfo getApiInformation(){
        return new ApiInfo("REST API",
                ...
                new Contact("Progressive Coder", "test.com", "mehdi.bakkali.94@gmail.com"),
                "API License",
                "API License URL",
